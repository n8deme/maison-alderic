...
export async function signupAction(
  ...
  if (!userId) {
    console.error("[signup] userId toujours null après listUsers");
    return { status: "error", errors: { _: "Impossible de récupérer l'ID utilisateur." } };
  }
  ...
  if (orgError) {
    ...
    console.error("[signup] orgError:", orgError);
    if (
