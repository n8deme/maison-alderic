...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/demo`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.5 },
    { url: `${base}/demo/expertises`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/demo/associes`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/demo/deals`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/demo/insights`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/demo/contact`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.6 },
    { url: `${base}/demo/carrieres`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.5 },
