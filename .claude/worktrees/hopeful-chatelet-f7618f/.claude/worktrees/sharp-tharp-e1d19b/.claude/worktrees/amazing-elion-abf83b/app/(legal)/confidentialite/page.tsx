...
export const metadata: Metadata = {
  title: "Politique de confidentialité — Maison Aldéric & Associés",
};
        ...
        <div className="space-y-12" style={{ fontFamily: "var(--font-body)" }}>
          <PrivacySection title="Responsable du traitement">
            <p>
              ...
              <strong>Maison Aldéric &amp; Associés SCRL</strong>, Avenue Louise 480, 1050 Bruxelles,
              Belgique — BCE 0123.456.789.
            </p>
            <p className="mt-4">
              Contact DPO : <a href="mailto:dpo@maison-alderic.be" style={{ color: "var(--bordeaux)" }}>dpo@maison-alderic.be</a>
            </p>
          </PrivacySection>
          ...
          <PrivacySection title="Vos droits">
            ...
            <p className="mt-6">
              ...
              <a href="mailto:dpo@maison-alderic.be" style={{ color: "var(--bordeaux)" }}>
                dpo@maison-alderic.be
              </a>
