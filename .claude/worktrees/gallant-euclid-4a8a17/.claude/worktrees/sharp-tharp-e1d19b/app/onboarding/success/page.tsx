  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-lg text-center space-y-4 mb-10">
        {isPaid && (
          <p className="text-xs font-medium uppercase tracking-widest" style={{ color: "#16a34a" }}>
            Paiement confirmé ✓
          </p>
        )}
        {!isPaid && (
      ...
      {/* Période d'essai / confirmation */}
      <div className="mt-8 text-center space-y-1">
        <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
          {isPaid
            ? "Votre abonnement inclut 14 jours d’essai gratuit — aucun débit avant la fin de la période."
